...
class Simulacao:
    def __init__(self, tipoCodificacao, tipoEnquadramento, tipoDeteccaoCorrecao, maxTamQuadro, chanceErro):
        ...
        match tipoCodificacao:
            ...
            case _:
                raise ValueError("Tipo de codificação portadora inválido. Escolha um valor entre 1 e 6.")
...
simulacao = Simulacao(tipoCodificacao=3, tipoEnquadramento=[2,1,2,1], tipoDeteccaoCorrecao = [1,2,3,3,2], maxTamQuadro=56, chanceErro=0)
